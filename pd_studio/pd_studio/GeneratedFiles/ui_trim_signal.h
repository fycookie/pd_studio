...
public:
    ...
    void setupUi(QWidget *trim_signal)
    {
        ...
        trim_signal->resize(789, 450);
        trim_signal->setMinimumSize(QSize(750, 450));
        ...
        widget_z->setMinimumSize(QSize(400, 150));
        ...
        widget_x->setMinimumSize(QSize(400, 150));
        ...
        widget_y->setMinimumSize(QSize(400, 150));
        ...
        widget->setMinimumSize(QSize(300, 450));
