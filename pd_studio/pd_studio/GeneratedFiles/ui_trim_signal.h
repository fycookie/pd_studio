...
public:
    ...
    void setupUi(QWidget *trim_signal)
    {
        ...
        trim_signal_main->setMinimumSize(QSize(800, 450));
        ...
        widget_z->setMinimumSize(QSize(450, 170));
        ...
        widget_x->setMinimumSize(QSize(450, 170));
        ...
        widget_y->setMinimumSize(QSize(450, 170));
